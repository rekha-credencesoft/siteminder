    ...
    const newPropertyResponse = await fetch(
      "https://api.bookonelocal.in/api-bookone/api/availability/getRatesAndAvailabilityForPropertyByDate",
      {
        ...
        headers: {
          ...
          Authorization:
            "Bearer eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJib29rb25ldGVzdGJ1c2luZXNzQGdtYWlsLmNvbSIsInNjb3BlcyI6IlJPTEVfUFJPUF9BRE1JTiIsImlhdCI6MTY1OTQxMjMwNCwiZXhwIjoxNjU5ODQ0MzA0fQ.zUnDxuPJ-USs2jE4wM8nUtBj2Ny1WYOi5rPaXqDTuuk",
...
export async function getStaticPaths() {
  return {
    paths: [
      ...
      { params: { propertyId: "575" } },
      { params: { propertyId: "578" } },
      { params: { propertyId: "495" } },
      { params: { propertyId: "424" } },
      { params: { propertyId: "547" } },
    ],
